...
# training the LogisticRegression model with Training data model.fit(X_train, Y_train)
...
# change the input data to a numpy array input_data_as_numpy_array= np.asarray(input_data)
...
prediction = model.predict(input_data_reshaped) print(prediction)
if (prediction[0]== 0):
